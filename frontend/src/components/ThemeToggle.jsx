...
function ThemeToggle() {
  ...
  return (
    <button
      ...
      style={{
        backgroundColor: theme === 'day' ? '#E0AF68' : '#24283B',
    ...
    >
      ...
      <div
        ...
        style={{
          left: theme === 'day' ? '2px' : 'calc(100% - 26px)',
        }}
      >
      ...
      {/* Background icons */}
      <div className="absolute inset-0 flex items-center justify-between px-2 text-xs opacity-0">
        <span className="text-white/70 ml-1">D</span>
        <span className="text-white/70 mr-1">N</span>
      </div>
    </button>
  )
}
